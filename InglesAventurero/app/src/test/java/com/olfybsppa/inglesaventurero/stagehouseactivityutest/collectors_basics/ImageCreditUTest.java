...
public class ImageCreditUTest {
  ...
  public void testEquals () {
    ...
    assertFalse(attribution1A.equals(attribution1C));
  }

  @Test
  public void testGetImageCredit () {
    ImageCredit imageCredit = attribution1A.constructImageCredit();
    assertEquals(imageCredit.artist, "artist_1_a");
    assertEquals(imageCredit.linkToLicense, "link_to_license_1_a");
    assertEquals(imageCredit.nameOfLicense, "name_of_license_1_a");
    assertEquals(imageCredit.artistImageName, "artist_image_name_1_a");
    assertEquals(imageCredit.imageUrlName, "imge_url_name_1_a");
    assertEquals(imageCredit.imageUrl, "image_url_1_a");
    assertEquals(imageCredit.artistFilename, "artist_filename_1_a");
  }
