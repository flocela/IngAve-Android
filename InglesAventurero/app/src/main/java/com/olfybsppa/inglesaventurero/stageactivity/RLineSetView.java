...
public class RLineSetView extends RelativeLayout implements LineView {
  ...
  private int       groupIDInColloquy;
  private int       positionInColloquy;
  ...
  public RLineSetView(Context context, AttributeSet attrs, final Actor actor) {
    super(context, attrs);
    ...
    scroller.setVisibility(VISIBLE);
    scroller.setOnClickListener(
      new View.OnClickListener() {
        @Override
        public void onClick(View v) {
          if (actor != null) {
            actor.noticeGroupHorizontalScroll(groupIDInColloquy);
          }
        }
      }
    );
    ...
    playAgainView.setOnClickListener(
      new View.OnClickListener() {
        ...
        public void onClick(View v) {
          if (actor != null) {
            actor.playAgain(groupIDInColloquy, positionInColloquy);
          }
        }
      }
    );
    ...
    playSlowView.setOnClickListener(
      new View.OnClickListener() {
        ...
        public void onClick(View v) {
          if (actor != null) {
            actor.playSlow(groupIDInColloquy, positionInColloquy);
          }
        }
      }
    );
  ...
  public void addMarker(){
    matchedMarkerView.setVisibility(VISIBLE);
  }
  ...
  public void clearMarkers() {
    matchedMarkerView.setVisibility(INVISIBLE);
  }
