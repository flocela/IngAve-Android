...
public class AdvisoryDialog extends DialogFragment {
	...
	public static AdvisoryDialog newInstance (Bundle startingBundle) {
		AdvisoryDialog cD = new AdvisoryDialog();
	...
	private void setEnglishText () {
		if (englishTitle == null)
			titleView.setText(getResources().getString(R.string.notification_eng));
		else
	...
	private void setSpanishText () {
		if (spanishTitle == null)
			titleView.setText(getResources().getString(R.string.notification_spn));
		else
