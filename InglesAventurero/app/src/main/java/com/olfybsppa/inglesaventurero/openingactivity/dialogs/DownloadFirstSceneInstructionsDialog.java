...
public class DownloadFirstSceneInstructionsDialog extends SimpleDialog {

  public static DownloadFirstSceneInstructionsDialog newInstance () {
    Bundle startingBundle = new Bundle();
    DownloadFirstSceneInstructionsDialog gD =
      new DownloadFirstSceneInstructionsDialog();
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    SpannableString instructionsSpanishSpannableString = new SpannableString("Oprima         Arriba, Para Descargar Una Escena.");
    ...
    SpannableString instructionsEnglishSpannableString = new SpannableString("Press              At Top, To Download A Scene.");
    instructionsEnglishSpannableString.setSpan(imgSpanBlack, 6, 18, Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
    ...
    okButton.setOnClickListener(new View.OnClickListener() {
      public void onClick(View v) {
        ...
        DownloadFirstSceneInstructionsDialog.this.dismiss();
      }
    });
  ...
  private void setGeneralDownloadInstructionsToFalse() {
    SharedPreferences sharedPreferences =
      PreferenceManager.getDefaultSharedPreferences(DownloadFirstSceneInstructionsDialog.this.getActivity());
